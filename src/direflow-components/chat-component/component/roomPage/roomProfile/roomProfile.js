...
import { api } from "../../../api";
import { roomTitleBackIcon, morePagePersonIcon, roomProfileInviteIcon, roomProfileSetIcon } from "../../../imgs/index";
                ...
                {showSetting ? (
                    ...
                    <div className="room_profile_wrap">
                        ...
                        <div className="info_room_btns">
                            ...
                            <div
                                className="info_room_btns-item info_room_btns-item-setting"
